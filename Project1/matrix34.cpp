...
Vector3 Matrix34::Dot(const Matrix34 &n,const Vector3 &m) {
	return Vector3(n.a.x * m.x + n.b.x * m.y + n.c.x * m.z,
		n.a.y * m.x + n.b.y * m.y + n.c.y * m.z,
		n.a.z * m.x + n.b.z * m.y + n.c.z * m.z);

	/*return Vector3(n.a.x * m.x + n.a.y * m.y + n.a.z * m.z,
		n.b.x * m.x + n.b.y * m.y + n.b.z * m.z,
		n.c.x * m.x + n.c.y * m.y + n.c.z * m.z);*/
}
